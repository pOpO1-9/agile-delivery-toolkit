...
| ID | Item | Est. | Done |
|----|------|------|------|
| P-012 | Formulaire nouveau challenge | M | Oui |
| P-015 | Invitation clippeur par email | M | Oui |
| P-018 | Upload création + statut pending | M | Oui |
| P-021 | Écran détail challenge (2 vues rôle) | S | Partiel |
...
3. Captures d’écran automatisées en fin de sprint (owner: delivery)
